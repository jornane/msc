...
%It will use NetFlow data to determine if traffic is repeated by other end-hosts,
% in other words, when an end-host receives a connection, it will see if this host starts initiating the same kind of connection to other end-hosts.
This thesis will focus on spreading of traffic as an anomaly, as malicious traffic will want to spread as far as possible,
