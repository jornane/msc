...
\include{netflow} % description of the NetFlow format
\include{graph} % description of the graph structure
\include{traffic} % how NetFlow traffic can be represented as a graph
\include{anomalies} % possible anomalies
\include{dosrank} % DOSRank proof of concept
\include{spreadrank} % SpreadRank algorithm
\include{results} % Findings (and performance)
